...
<section className="mb-14">
  ...
  <p className="text-body-md text-silver mb-8">
    Before a page enters the hierarchy at Stage 1, it clears the{" "}
    <strong className="text-white">Stage 0 prerequisite</strong>: Self-Evidence
    ≥ 7/10 on Krug&apos;s Trunk Test. Pages that aren&apos;t self-evident to a
    human reader cannot be extracted by an LLM with the confidence required
    to land a named citation. See the rubric on the{" "}
    <Link
      href="/citation-score"
      className="text-electric hover:text-electric-light underline-offset-4 hover:underline"
    >
      Citation Score™ methodology page
    </Link>
    .
  </p>
  <Reveal stagger={0.06} className="grid gap-4">
    <div className="rounded-[var(--radius-lg)] border border-electric/30 bg-electric/5 p-6 md:p-7">
      <div className="flex items-baseline gap-4 mb-3">
        <p className="text-body-xs font-mono text-electric">00</p>
        <h3 className="text-heading-md text-white">Self-Evidence ≥ 7/10 (prerequisite gate)</h3>
      </div>
      <p className="text-body-md text-cloud mb-3 italic">
        Can a human reader answer six questions about the page in five seconds?
      </p>
      <p className="text-body-md text-silver">
        Krug&apos;s Trunk Test scores self-evidence on six answers — site identity,
        page identity, primary sections, current location, CTA, and buyer-journey
        position. Pages at 4–6/10 are rewritten before hierarchy work begins; pages
        at 7–9 enter Stage 1; pages at 10 are reference exemplars and feed our
        internal Prototype Match training set. The same processing-fluency signals
        that drive 50ms first-impression encoding in human cognition (Jones et al.
        2015) drive LLM extraction confidence.
      </p>
    </div>
...
<section className="mb-14">
  ...
  <ol className="space-y-4 text-body-md text-silver list-decimal pl-6">
    ...
    <li>
      ...
      {" "}subscription instruments the lift; the
...
<section className="mb-12 rounded-[var(--radius-lg)] border border-[var(--color-border-default)] bg-[var(--color-surface-elevated)] p-6 md:p-7">
  ...
  <h3 className="text-heading-md text-white text-balance mb-3">
    Stage 3 in depth — the schema and content pattern AI engines reward.
  </h3>
  <p className="text-body-md text-silver mb-4">
    Brief #002 deep-dives the highest-leverage stage of the hierarchy: Structured Extractability. The schema bundle (FAQPage · HowTo · Article · Person · Breadcrumb), the five-element content pattern, the five antipatterns Wiele sees in pre-engagement audits, and the Wiele extractability checklist as an ownable artefact.
  </p>
  <Link
    href="/citation-brief/stage-3-structured-extractability"
...
<section className="mb-14">
  ...
  <p className="text-body-sm text-smoke mt-5">
    ...
    the named-competitor lift trace inside the{" "}
    <Link
      href="/citation-score"
      className="text-electric hover:text-electric-light underline-offset-4 hover:underline"
    >
