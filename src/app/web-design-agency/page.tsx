...
const division = getDivisionBySlug("web-design-agency")!;
...
export default function WebDesignAgencyPage() {
  ...
  return (
    <>
      <JsonLd schema={breadcrumbs} id="schema-breadcrumb-web-design-agency" />
      <JsonLd schema={service} id="schema-service-web-design-agency" />
      <JsonLd schema={faq} id="schema-faq-web-design-agency" />
