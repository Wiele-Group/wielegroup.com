...
const STATIC_ROUTES: {
  ...
  {
    path: "/systems/brand-authority",
    priority: 0.85,
    changeFrequency: "monthly",
  },
  {
    path: "/systems/web-experience",
    priority: 0.85,
    changeFrequency: "monthly",
  },
  ...
  {
    path: "/services/premium-brand-site-system",
    priority: 0.9,
    changeFrequency: "monthly",
  },
  ...
  {
    path: "/services/ai-visibility-monitoring",
    priority: 0.9,
    changeFrequency: "monthly",
  },
  ...
  /* v3.9.9 (2026-05-15) — Citation Brief #005.
       Brand Semantics Infrastructure — the 2026 mandate Google named
       first. Think with Google 2026 Marketing Predictions Guide source.
       Pre-GML 2026 (May 20) anchoring. Same priority + frequency as the
       rest of the brief cluster. Note: STATIC_ROUTES is hand-maintained
       (not derived from getAllBriefSlugs) so each brief needs a manual
       entry — surfaced by v3.9.9 §6 G8 fail. */
  {
    path: "/citation-brief/brand-semantics-infrastructure",
    priority: 0.85,
    changeFrequency: "monthly",
  },
...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const caseStudyEntries: MetadataRoute.Sitemap =
    getVisibleCaseStudyManifest().map(({ slug, lastUpdated }) => ({
